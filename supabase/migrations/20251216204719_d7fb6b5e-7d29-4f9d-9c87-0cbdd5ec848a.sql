-- SECURITY FIX: Add authorization checks to complete_order_atomic
-- This function now validates:
-- 1. If called by service_role (webhook) - order must already be 'paid'
-- 2. If called by authenticated user - must be admin
-- 3. User ID must match order owner
-- 4. Idempotency - prevents re-completion of already completed orders
...
BEGIN
  ...
  -- ==========================================
  -- ORDER PROCESSING (existing logic)
  -- ==========================================
